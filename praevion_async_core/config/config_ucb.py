UCB_CONFIG = {
    ...
    "acq_func_kwargs": {
        "kappa": 4.0,                       # Start with strong exploration
        "scheduler": {                      # Add scheduler to taper exploration
            "type": "periodic-exp-decay",
            "period": 40,                   # Every 50 evaluations, apply decay
            "kappa_final": 1.15             # Don't decay all the way to greediness (0.25 is too aggressive)
        }
    },
