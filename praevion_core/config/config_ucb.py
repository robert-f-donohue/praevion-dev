UCB_CONFIG = {
    ...
    "acq_func_kwargs": {
        ...
        "scheduler": {  # Add scheduler to taper exploration
            ...
            "kappa_final": 0.25,  # Don't decay all the way to greediness
        },
    },
    ...
    "multi_point_strategy": "qUCBd",  # Vectorized/decayed UCB for smart parallelism
    "moo_scalarization_strategy": "AugChebyshev",  # Adds 1-norm penalty front edge discovery
    "moo_scalarization_weight": None,  # Randomized weights for full front coverage
