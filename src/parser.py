import pandas as pd
from src.utils import extract_named_table, clean_table_with_headers
...
def extract_construction_areas(filepath):
    ...
    zone_df["Wall Area [m2]"] = pd.to_numeric(zone_df["Above Ground Gross Wall Area [m2]"], errors="coerce")
