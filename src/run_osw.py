...
def run_osw_and_organize_logs(osw_path, run_logs_dir):
    ...
    - Creates a clean run directory in `5-osws/`
    ...
    # Create isolated run directory: 5-osws/test_name_run/
    ...
    if isinstance(result, subprocess.CalledProcessError) or isinstance(result, subprocess.CompletedProcess):
